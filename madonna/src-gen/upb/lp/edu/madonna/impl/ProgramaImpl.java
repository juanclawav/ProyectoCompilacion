 ...
 * </p>
 * <ul>
 *   <li>{@link upb.lp.edu.madonna.impl.ProgramaImpl#getName <em>Name</em>}</li>
 *   <li>{@link upb.lp.edu.madonna.impl.ProgramaImpl#getProg <em>Prog</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProgramaImpl extends MinimalEObjectImpl.Container implements Programa
{
  ...
  {
    return MadonnaPackage.Literals.PROGRAMA;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MadonnaPackage.PROGRAMA__NAME, oldName, name));
  }
  ...
  public EList<Instrucciones> getProg()
  {
    if (prog == null)
    {
      prog = new EObjectContainmentEList<Instrucciones>(Instrucciones.class, this, MadonnaPackage.PROGRAMA__PROG);
    }
    return prog;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MadonnaPackage.PROGRAMA__PROG:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MadonnaPackage.PROGRAMA__NAME:
        return getName();
      case MadonnaPackage.PROGRAMA__PROG:
        return getProg();
    }
